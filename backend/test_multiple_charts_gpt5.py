...
if 'visualizations' in result:
    print(f"\n[SUCCESS] MULTIPLE VISUALIZATIONS FOUND: {len(result['visualizations'])} charts")
    ...
    print("\n[WARNING] SINGLE VISUALIZATION FOUND (should be multiple):")
...
with open('test_gpt5_result.json', 'w') as f:
    ...
    print("\nFull result saved to test_gpt5_result.json")